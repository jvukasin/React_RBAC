...
import com.master.backend.dto.UserInfoDTO;
...
public class InventoryController {
    ...
    @RequestMapping(value = "/changeItem", method = RequestMethod.PUT)
    public ResponseEntity<InventoryDTO> changeItem(@RequestBody InventoryDTO dto) {
        return new ResponseEntity<>(inventService.changeItem(dto), HttpStatus.OK);
    }
