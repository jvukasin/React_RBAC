package com.master.backend.security.config;

import com.master.backend.security.CustomUserDetailsService;
import com.master.backend.security.TokenUtils;
import com.master.backend.security.auth.RestAuthenticationEntryPoint;
import com.master.backend.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/procurements/**").permitAll()
